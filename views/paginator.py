...
class Paginator(discord.ui.View):
    ...
    async def start(self, itx: core.Interaction[core.Doom]) -> None:
    ...
    async def interaction_check(self, itx: core.Interaction[core.Doom]) -> bool:
        """
    ...
    async def first(
        self, itx: core.Interaction[core.Doom], button: discord.ui.Button
    ) -> None:
    ...
    async def change_page(self, itx: core.Interaction[core.Doom]) -> None:
...
class PageNumberModal(discord.ui.Modal):
    ...
    async def on_error(
        self, itx: core.Interaction[core.Doom], error: Exception
    ) -> None:
