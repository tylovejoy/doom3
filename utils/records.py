...
class MapCodeAutoTransformer(MapCodeTransformer):
    async def autocomplete(
        ...
        return await cogs._autocomplete(value, itx.client.map_codes_choices)
...
class MapLevelTransformer(app_commands.Transformer):
    ...
    async def autocomplete(
        ...
        return await cogs._autocomplete(
            value,
...
class UserTransformer(app_commands.Transformer):
    ...
    async def autocomplete(
        ...
        return await cogs._autocomplete(value, itx.client.users_choices)
